    ...
    <script>
        ...
        function downloadPDF() {
            ...
            img.onload = function() {
                ...
                doc.setFontSize(10);
                doc.text(`Folio: ${<?= $inventario->getId()?>}`, 195, 25, { align: "right" });
                doc.text(`Fecha: ${<?= json_encode($inventario->getFecha())?>}`, 195, 30, { align: "right" });
                ...
                // Firma
                doc.text("ATENTAMENTE:", 105, yPosition + 10, { align: "center" });
                doc.text("____________________________________________", 105, yPosition + 30, { align: "center" });
                doc.text("Ing. Gerardo Moreno Borja", 105, yPosition + 35, { align: "center" });
